<nav class="fixed top-0 z-40 w-full bg-white bg-opacity-70 backdrop-blur-sm start-0">
  <div class="container flex flex-wrap items-center justify-between p-4 mx-auto xl:max-w-screen-xl">
  <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
    <img src="{{url('/assets/images/logo-gelora.png')}}" class="h-9 md:h-10" alt="Gelora Logo">
